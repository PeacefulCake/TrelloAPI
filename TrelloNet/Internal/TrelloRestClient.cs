...
namespace TrelloNet.Internal
{
    ...
    public TrelloRestClient(string applicationKey, bool createEmptyProxy = false)
      : base(BASE_URL)
    {
      ...
      //this.Proxy = new WebProxy("tmgnpo03.comp.npo", false, null, CredentialCache.DefaultCredentials);
    }
